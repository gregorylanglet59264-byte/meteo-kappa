...
def main():
    ...
    # 2. ÉTAPE 2 : Génération des cartes pour la France, les régions et tous les départements
    zones_france = ["france"]
    zones_regions = ["hdf", "normandie", "idf", "ges", "ara", "naq", "occ", "paca", "bfc", "bre", "pdl", "cvl", "cor"]
    zones_npdc = ["npdc"]
    zones_depts = [
